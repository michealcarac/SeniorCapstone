...
#
# Generated by export_simulation on Sun Oct 16 12:56:56 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './BTN_LED_Linux.sh' script.

./BTN_LED_Linux.sh -reset_run
...
./BTN_LED_Linux.sh -noclean_files

For more information on the script, please type './BTN_LED_Linux.sh -help'.
