...
HD_PWD='C:/Users/spixy/Documents/00_Github/SeniorCapstone/Milestone3/Milestone3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BTN_LED_Linux_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BTN_LED_Linux_wrapper.tcl -notrace
