...
HD_PWD='C:/Users/spixy/Documents/00_Github/SeniorCapstone/Milestone3/Milestone3.runs/BTN_LED_Linux_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BTN_LED_Linux_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BTN_LED_Linux_auto_pc_0.tcl
