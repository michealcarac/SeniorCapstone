...
HD_PWD='C:/Users/spixy/Documents/00_Github/SeniorCapstone/PL_BTN_LED/PL_BTN_LED.runs/BTN_LED_btn_to_led_clk_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BTN_LED_btn_to_led_clk_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BTN_LED_btn_to_led_clk_0_0.tcl
