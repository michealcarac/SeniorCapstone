...
################################################################
# This is a generated script based on design: Imp
#
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
clarkson.edu:SeniorLab:I2C_LCD_Transmitter_DEBUG:1.1\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set LCD_SCL_0 [ create_bd_port -dir IO LCD_SCL_0 ]
  set LCD_SDA_0 [ create_bd_port -dir IO LCD_SDA_0 ]
  set lcd_reset_n [ create_bd_port -dir I lcd_reset_n ]
  set reset [ create_bd_port -dir I -type rst reset ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] $reset
  set sysclk_100Mhz [ create_bd_port -dir I -type clk sysclk_100Mhz ]

  # Create instance: I2C_LCD_Transmitter_1, and set properties
  set I2C_LCD_Transmitter_1 [ create_bd_cell -type ip -vlnv clarkson.edu:SeniorLab:I2C_LCD_Transmitter_DEBUG:1.1 I2C_LCD_Transmitter_1 ]
  set_property -dict [ list \
   CONFIG.LCD_I2C_BUS_CLK {100000} \
 ] $I2C_LCD_Transmitter_1
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  # Create instance: rst_sysclk_100Mhz_100M, and set properties
  set rst_sysclk_100Mhz_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_sysclk_100Mhz_100M ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins I2C_LCD_Transmitter_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_0_1 [get_bd_ports sysclk_100Mhz] [get_bd_pins I2C_LCD_Transmitter_1/s00_axi_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_sysclk_100Mhz_100M/slowest_sync_clk]
  connect_bd_net -net Net [get_bd_ports LCD_SDA_0] [get_bd_pins I2C_LCD_Transmitter_1/LCD_SDA]
  connect_bd_net -net Net1 [get_bd_ports LCD_SCL_0] [get_bd_pins I2C_LCD_Transmitter_1/LCD_SCL]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports reset] [get_bd_pins rst_sysclk_100Mhz_100M/ext_reset_in]
  connect_bd_net -net lcd_reset_n_0_1 [get_bd_ports lcd_reset_n] [get_bd_pins I2C_LCD_Transmitter_1/lcd_reset_n]
  connect_bd_net -net rst_sysclk_100Mhz_100M_peripheral_aresetn [get_bd_pins I2C_LCD_Transmitter_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_sysclk_100Mhz_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs I2C_LCD_Transmitter_1/S00_AXI/S00_AXI_reg] -force
