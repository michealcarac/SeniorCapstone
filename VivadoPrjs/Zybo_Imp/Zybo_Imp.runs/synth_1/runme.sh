...
HD_PWD='/home/cekp/Desktop/GitHub/SeniorCapstone/VivadoPrjs/Zybo_Imp/Zybo_Imp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Imp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Imp_wrapper.tcl
