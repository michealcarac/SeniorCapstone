...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.LCD \
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Zybo_LCD.gen/sources_1/bd/LCD/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Zybo_LCD.gen/sources_1/bd/LCD/ipshared/5765/hdl" \
       +incdir+"../../../../Zybo_LCD.gen/sources_1/bd/LCD/ipshared/ec67/hdl" \
       +incdir+"../../../../Zybo_LCD.gen/sources_1/bd/LCD/ipshared/5765/hdl" \
