...
################################################################
# This is a generated script based on design: KB
#
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
empyrea.dev:AXICommunication:AXI_PS2_Keyboard:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ascii [ create_bd_port -dir O -from 6 -to 0 ascii ]
  ...
  # Create instance: AXI_PS2_Keyboard_0, and set properties
  set AXI_PS2_Keyboard_0 [ create_bd_cell -type ip -vlnv empyrea.dev:AXICommunication:AXI_PS2_Keyboard:1.0 AXI_PS2_Keyboard_0 ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXI_PS2_Keyboard_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net AXI_PS2_Keyboard_0_ascii [get_bd_ports ascii] [get_bd_pins AXI_PS2_Keyboard_0/ascii]
  connect_bd_net -net AXI_PS2_Keyboard_0_ascii_new [get_bd_ports ascii_new] [get_bd_pins AXI_PS2_Keyboard_0/ascii_new]
  connect_bd_net -net M_AXI_GP0_ACLK_0_1 [get_bd_ports clk] [get_bd_pins AXI_PS2_Keyboard_0/s00_axi_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_100M/slowest_sync_clk]
  ...
  connect_bd_net -net ps2_clk_0_1 [get_bd_ports ps2_clk] [get_bd_pins AXI_PS2_Keyboard_0/ps2_clk]
  connect_bd_net -net ps2_data_0_1 [get_bd_ports ps2_data] [get_bd_pins AXI_PS2_Keyboard_0/ps2_data]
  connect_bd_net -net rst_clk_100M_peripheral_aresetn [get_bd_pins AXI_PS2_Keyboard_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_PS2_Keyboard_0/S00_AXI/S00_AXI_reg] -force
