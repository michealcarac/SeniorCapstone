...
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { ascii_new }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
...
##Pmod Header JE                                                                                                                  
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33     } [get_ports ascii_new]; #IO_L4P_T0_34 Sch=je[1]						 
