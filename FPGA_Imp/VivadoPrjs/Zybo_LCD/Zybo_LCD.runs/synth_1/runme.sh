...
HD_PWD='/home/cekp/Desktop/GitHub/SeniorCapstone/FPGA_Imp/VivadoPrjs/Zybo_LCD/Zybo_LCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LCD_wrapper.tcl
