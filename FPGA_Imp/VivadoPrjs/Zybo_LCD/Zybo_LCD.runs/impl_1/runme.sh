...
HD_PWD='/home/cekp/Desktop/GitHub/SeniorCapstone/FPGA_Imp/VivadoPrjs/Zybo_LCD/Zybo_LCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LCD_wrapper.tcl -notrace
