...
proc init_gui { IPINST } {
  ...
  set PS2_CLK_FREQ [ipgui::add_param $IPINST -name "PS2_CLK_FREQ" -parent ${Page_0}]
  set_property tooltip {(Hz)} ${PS2_CLK_FREQ}
  set PS2_DEBOUNCE_COUNTER_SIZE [ipgui::add_param $IPINST -name "PS2_DEBOUNCE_COUNTER_SIZE" -parent ${Page_0}]
  set_property tooltip {Should solve the equation (x)      (2^x)/(PS2 Clock Freq) = 5us} ${PS2_DEBOUNCE_COUNTER_SIZE}
  set TIMER_OUTPUT_WIDTH [ipgui::add_param $IPINST -name "TIMER_OUTPUT_WIDTH" -parent ${Page_0}]
  set_property tooltip {Timer data width, default 32 bit for 32 bit register} ${TIMER_OUTPUT_WIDTH}
  set TIMER_CLOCK_DIVIDER [ipgui::add_param $IPINST -name "TIMER_CLOCK_DIVIDER" -parent ${Page_0}]
  set_property tooltip {Period of timer (Resolution of LSB) =  (Timer Clock Divider times 2)/(PS2 Clock Frequency)} ${TIMER_CLOCK_DIVIDER}
