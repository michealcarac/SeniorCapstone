...
--               c:/Users/spixy/Documents/00_Github/SeniorCapstone/Milestone3/BlockDesigns/ButtonTest/ButtonTest/ip/ButtonTest_clk_wiz_0_0/ButtonTest_clk_wiz_0_0_sim_netlist.vhdl
...
entity ButtonTest_clk_wiz_0_0_clk_wiz is
  port (
...
end ButtonTest_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of ButtonTest_clk_wiz_0_0_clk_wiz is
  signal clk_in1_ButtonTest_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_ButtonTest_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_ButtonTest_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_ButtonTest_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_ButtonTest_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_ButtonTest_clk_wiz_0_0,
...
entity ButtonTest_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of ButtonTest_clk_wiz_0_0 : entity is true;
end ButtonTest_clk_wiz_0_0;

architecture STRUCTURE of ButtonTest_clk_wiz_0_0 is
begin
inst: entity work.ButtonTest_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
