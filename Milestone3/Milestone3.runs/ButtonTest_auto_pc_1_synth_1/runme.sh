...
HD_PWD='C:/Users/spixy/Documents/00_Github/SeniorCapstone/Milestone3/Milestone3.runs/ButtonTest_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ButtonTest_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ButtonTest_auto_pc_1.tcl
