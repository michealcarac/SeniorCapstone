...
HD_PWD='C:/Users/spixy/Documents/00_Github/SeniorCapstone/Tutorial/Tutorial.runs/Tutorial_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tutorial_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tutorial_axi_gpio_0_0.tcl
