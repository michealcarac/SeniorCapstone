...
HD_PWD='C:/Users/spixy/Documents/00_Github/SeniorCapstone/Tutorial/Tutorial.runs/Tutorial_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tutorial_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tutorial_auto_ds_0.tcl
