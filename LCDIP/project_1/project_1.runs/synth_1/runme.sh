...
HD_PWD='C:/Users/nicks/Documents/SeniorCapstone/LCDIP/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_LCD_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Level_LCD_IP.tcl
