...
HD_PWD='C:/Users/nicks/Documents/SeniorCapstone/LCDIP/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_LCD_IP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Level_LCD_IP.tcl -notrace
