...
#
# Generated by export_simulation on Sat Oct 15 23:10:06 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './BTN_LED.sh' script.

./BTN_LED.sh -reset_run
...
./BTN_LED.sh -noclean_files

For more information on the script, please type './BTN_LED.sh -help'.
