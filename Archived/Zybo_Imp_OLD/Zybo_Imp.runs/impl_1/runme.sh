...
HD_PWD='/home/cekp/Desktop/GitHub/SeniorCapstone/VivadoPrjs/Zybo_Imp/Zybo_Imp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Imp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Imp_wrapper.tcl -notrace
