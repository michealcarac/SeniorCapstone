...
#
# Generated by export_simulation on Fri Oct 14 01:15:10 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './Tutorial.sh' script.

./Tutorial.sh -reset_run
...
./Tutorial.sh -noclean_files

For more information on the script, please type './Tutorial.sh -help'.
